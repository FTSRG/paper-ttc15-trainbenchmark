...
%	\includegraphics[scale=0.24]{figures/pattern-#1}
%	\includegraphics[scale=0.24]{figures/transformation-#1}
%	\\
%}
...
\noindent\framebox[\textwidth][c]{(3 Tasks + 2 Extension Tasks) $\times$ 2 validation scenarios $\times$ 2 change set sizes $\times$ up to 1 points = 20 points}
